...
def main():
    ...
    target = output / ("V5-BEST-DOWNLOAD-" + datetime.now(timezone.utc).strftime("%Y%m%d-%H%M%S-%f") + ".tar.gz")
    paths = [checkpoint, manifest_path, root / "configs/train_scaffold_5090_linker_v5.yaml"]
