...
def test_v5_model_config_constructs_lightning_boundary(monkeypatch):
    config_path = Path(__file__).parents[1] / "configs" / "train_scaffold_5090_linker_v5.yaml"
...
def test_linker_v5_release_builds_the_locked_split_and_full_mask_validation():
    ...
    config = yaml.safe_load((root / "configs" / "train_scaffold_5090_linker_v5.yaml").read_text(encoding="utf-8"))
